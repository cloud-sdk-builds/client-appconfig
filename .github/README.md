...
[`@aws-sdk/client-appconfig`](https://www.npmjs.com/package/@aws-sdk/client-appconfig/v/3.332.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appconfig@3.332.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fcnB/PKPC5whLuVzZnhLDem5a5ywHzbVZnSt9J3od78JMDNXkt3RYD2LUylv8GI+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-appconfig": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appconfig@3.332.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appconfig@3.332.0/index.min.mjs": "sha384-fcnB/PKPC5whLuVzZnhLDem5a5ywHzbVZnSt9J3od78JMDNXkt3RYD2LUylv8GI+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-appconfig/blob/refs/tags/3.332.0/LICENSE
```
